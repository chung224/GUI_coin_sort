...
y_axis_vol = df['5_day_volatility'].tolist()
y_axis_vol = y_axis_vol[:99]
df = df.dropna()
...
y_axis_2 = y_axis_2[:99]
y_axis_2_vol = df_2['5_day_volatility'].tolist()
y_axis_2_vol = y_axis_2_vol[:99]
...
class Ui_MainWindow(QWidget):
    def setupUi(self, MainWindow):
        ...
        self.graphicsView_3.addLegend(size=(10,30),offset=(80,-120))
        ...
        self.graphicsView_4.addLegend(size=(10,30),offset=(80,-120))
